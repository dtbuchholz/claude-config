...
1. `references/rs-setup/01-workspace-structure.md`
2. `references/rs-setup/02-rustfmt-config.md`
3. `references/rs-setup/03-clippy-config.md`
4. `references/rs-setup/04-testing-config.md`
5. `references/rs-setup/05-git-hooks.md`
6. `references/rs-setup/06-pre-push-script.md`
7. `references/rs-setup/07-ci-pipeline.md`
8. `references/rs-setup/08-dependencies-and-checklist.md`

## Deep Dives (load only if the user opts in)

| Reference                                   | When to Read                                         |
| ------------------------------------------- | ---------------------------------------------------- |
| `references/rs-test-infrastructure.md`      | Property-based testing, nextest, coverage deep dive  |
| `references/rs-design-metrics.md`           | Clippy pedantic as design metrics, complexity limits |
| `references/rs-architecture-enforcement.md` | cargo-deny, visibility, feature flag architecture    |
| `references/rs-mutation-testing.md`         | cargo-mutants setup and CI integration               |
